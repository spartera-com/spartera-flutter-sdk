...
try {
    final result = api_instance.getConnectionsByIdSampleData(companyId, connectionId);
    print(result);
} catch (e) {
    print('Exception when calling ConnectionsApi->getConnectionsByIdSampleData: $e\n');
}
```
