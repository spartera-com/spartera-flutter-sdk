...
**snippetId** | **int** | References snippets.snippet_id — Predefined code snippets to accelerate insight creation. See GET /snippets for valid values. Optional. | [optional] 
...
**source_** | **String** | Required. One of: MANUAL, AUTOMATIC. | 
