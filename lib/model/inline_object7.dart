...
class InlineObject7 {
  ...
  @override
  String toString() => 'InlineObject7[code=$code, message=$message]';
  ...
  static List<InlineObject7> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <InlineObject7>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InlineObject7.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InlineObject7> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = InlineObject7.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<InlineObject7>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InlineObject7>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InlineObject7.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
