...
class PostsUpdate {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PostsUpdate &&
    other.userId == userId &&
  ...
  @override
  String toString() => 'PostsUpdate[userId=$userId, companyId=$companyId, title=$title, category=$category, teaser=$teaser, contentHtml=$contentHtml, insightsUsed=$insightsUsed, generationCreativity=$generationCreativity, generationTargetWordCount=$generationTargetWordCount, generationTone=$generationTone, generationIncludeCitations=$generationIncludeCitations, generationSubheadingCount=$generationSubheadingCount, generationTemperature=$generationTemperature, dataCostCredits=$dataCostCredits, serviceCostCredits=$serviceCostCredits, totalCostCredits=$totalCostCredits, successfulInsightsCount=$successfulInsightsCount, failedInsightsCount=$failedInsightsCount, generationTimeMs=$generationTimeMs, isPublished=$isPublished, publishedAt=$publishedAt, viewCount=$viewCount, lastEditedAt=$lastEditedAt]';
  ...
  static List<PostsUpdate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PostsUpdate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PostsUpdate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostsUpdate> mapFromJson(dynamic json) {
    final map = <String, PostsUpdate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PostsUpdate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PostsUpdate-objects as value to a dart map
  static Map<String, List<PostsUpdate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostsUpdate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostsUpdate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
