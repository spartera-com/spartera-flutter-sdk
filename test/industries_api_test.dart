...
void main() {
  ...
  group('tests for IndustriesApi', () {
    ...
    test('test listIndustries', () async {
      // TODO
    });
    ...
    test('test listIndustriesActive', () async {
      // TODO
    });
