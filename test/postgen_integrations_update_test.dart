...
// tests for PostgenIntegrationsUpdate
void main() {
  // final instance = PostgenIntegrationsUpdate();

  group('test PostgenIntegrationsUpdate', () {
    ...
    test('to test the property `credentialsSecretName`', () async {
      // TODO
    });
